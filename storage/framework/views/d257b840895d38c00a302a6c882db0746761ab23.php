<?php $__env->startSection('title','الأقسام الفرعية'); ?>
        ...
        <div class="col-lg-12">
            <div class="card-box">
                ...
                <div class="dropdown pull-right">
                   <a href="<?php echo e(route('categories.create','type=subcats')); ?>" class="btn btn-custom  waves-effect waves-light">
                    <span class="m-l-5">
                ...
                <div class="pull-right" style="margin-left: 10px;">
                    <?php if(isset($type) && $type == 'search'): ?>
                        <a href="<?php echo e(route('subcategories')); ?>" style="float: left; margin-right: 15px;" class="btn btn-primary btn-sm"><i class="fa fa-eye" style="margin-left: 5px"></i>مشاهدة الأقسام
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <?php if(isset($type) && $type != 'search'): ?>
                    <div class="row">
                        <form action="<?php echo e(route('categories.search')); ?>" method="get">
                            ...
                            <div class="col-lg-3"> 
                                <label>اسم القسم الرئيسلى</label>
                            ...
                            <div class="col-lg-3"> 
                                ...
                                <select name="id" class="form-control">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $subcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <option value="<?php echo e($value->id); ?>"><?php echo e($value->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td style="width: 10%;">
                             ...
                             <td>
                                <?php $cat = \App\Category::find($category->parent_id); ?>
                                <?php if($cat): ?>
                                    <?php echo e($cat->name); ?>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(route('categories.edit', $category->id).'?type=subcats'); ?>"
                                   class="btn btn-icon btn-xs waves-effect btn-default m-b-5">
