<?php $__env->startSection('title','المدن'); ?>
        ...
        <div class="col-lg-12">
            <div class="card-box">
                <div class="dropdown pull-right">
                    <a href="<?php echo e(route('cities.create')); ?>" class="btn btn-custom waves-effect waves-light">إضافة <span class="m-l-5">
                ...
                <div class="col-sm-4 col-sm-offset-4 pull-left">
                    <?php if(isset($type) && $type == 'search'): ?>
                        <a href="<?php echo e(route('cities.index')); ?>" style="float: left; margin-right: 15px;" class="btn btn-primary btn-sm"><i class="fa fa-eye" style="margin-left: 5px"></i>مشاهدة المدن
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <?php if(isset($type) && $type != 'search'): ?>
                    <div class="row">
                        <form action="<?php echo e(route('cities.search')); ?>" method="get">
                            ...
                            <div class="col-lg-4"> 
                                ...
                                <select name="city" class="form-control">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        $('body').on('click', '.elementStatus', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(route('city.activateArea')); ?>',
        ...
        $('body').on('click', '.removeElement', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(route('cities.destroy','+id+')); ?>',
                        data: {id: id},
                        dataType: 'json',
                        success: function (data) {
                            if (data.status == true) {
