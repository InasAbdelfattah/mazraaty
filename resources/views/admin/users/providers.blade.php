                ...
                <table id="datatable-fixed-header" class="table  table-striped">
                    ...
                    @foreach($users as $user)
                        ...
                        <tr>
                            ...
                            <a href="javascript:;" id="activateRow{{ $user->id }}" data-id="{{ $user->id }}" data-status="{{!$user->is_active}}"
                            ...
                            <td>
                                <a target="_blank" href="{{ route('companies.show', $user->company_id) }}"class="btn btn-icon btn-xs waves-effect btn-default m-b-5">
