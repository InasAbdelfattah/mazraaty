        ...
        <div class="col-lg-12">
            <div class="card-box">
                <div class="dropdown pull-right">
                    <a href="{{ route('measurementUnits.create') }}" class="btn btn-custom waves-effect waves-light">إضافة <span class="m-l-5">
                ...
                <div class="col-sm-4 col-sm-offset-4 pull-left">
                    @if(isset($type) && $type == 'search')
                        <a href="{{ route('measurementUnits.index') }}" style="float: left; margin-right: 15px;" class="btn btn-primary btn-sm"><i class="fa fa-eye" style="margin-left: 5px"></i>مشاهدة وحدات القياس
                        </a>
                    @endif
                </div>
                ...
                @if(isset($type) && $type != 'search')
                    <div class="row">
                        <form action="{{route('measurementUnits.search')}}" method="get">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('measurementUnits.edit', $row->id) }}"
        ...
        $('body').on('click', '.elementStatus', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: 'POST',
                        url: '{{ route('measurementUnits.activateMeasurement') }}',
            ...
            if (sum.length > 0) {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        $.ajax({
                            type: 'POST',
                            url: '{{ route('measurementUnits.group.delete') }}',
                            data: {ids: sum},
                            dataType: 'json',
                            success: function (data) {
                                if (data) {
        ...
        $('body').on('click', '.removeElement', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: 'POST',
                        url: '{{ route('measurementUnits.destroy','+id+') }}',
                        data: {id: id},
                        dataType: 'json',
                        success: function (data) {
                            if (data.status == true) {
